...
import com.example.firebasestarter.databinding.ActivityMainLeaderBinding;
...
public class MainActivityLeader extends AppCompatActivity {

    ActivityMainLeaderBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding= ActivityMainLeaderBinding.inflate(getLayoutInflater());
        ...
        binding.timePassMood.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(MainActivityLeader.this,EditProfileActivity3.class);
                    ...
                    try {
                        ...
                        FirebaseStorage.getInstance().getReference().child("profile_pictures").child(auth.getUid()).getFile(file).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(MainActivityLeader.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
                    } catch (IOException e) {
                        e.printStackTrace();
        ...
        binding.btnLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                auth.signOut();
                Intent intent=new Intent(MainActivityLeader.this,LoginActivity.class);
                startActivity(intent);
            }
        });
