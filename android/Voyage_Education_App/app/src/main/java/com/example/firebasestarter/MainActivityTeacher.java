    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.timePassMood.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(MainActivityTeacher.this,EditProfileActivity3.class);
        ...
        binding.angryMood.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(MainActivityTeacher.this,VoyagramActivity.class);
                startActivity(intent);
            }
        });
                    ...
                    try {
                        ...
                        FirebaseStorage.getInstance().getReference().child("profile_pictures").child(auth.getUid()).getFile(file).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(MainActivityTeacher.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
                    } catch (IOException e) {
                        e.printStackTrace();
        ...
        binding.btnLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                auth.signOut();
                Intent intent=new Intent(MainActivityTeacher.this,LoginActivity.class);
                startActivity(intent);
            }
        });
