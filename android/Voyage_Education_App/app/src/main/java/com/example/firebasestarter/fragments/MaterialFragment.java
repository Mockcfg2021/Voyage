...
public class MaterialFragment extends Fragment {
    ...
    public static com.example.firebasestarter.fragments.MaterialFragment getInstance(String courseId) {
        com.example.firebasestarter.fragments.MaterialFragment fragment = new com.example.firebasestarter.fragments.MaterialFragment();
